//Author: TheRob
//Description: Russian Army Alpenflage AK-12
// ====================================================================================
...
class blu_f {
    ...
    #define WEST_RIFLE_MAG "hlc_30Rnd_545x39_t_ak:8"

	//GL Rifle
    #define WEST_GLRIFLE "hlc_rifle_ak12GL"
    #define WEST_GLRIFLE_MAG "hlc_30Rnd_545x39_t_ak:8"
    #define WEST_GLRIFLE_MAG_SMOKE "hlc_GRD_White:4","hlc_GRD_green:2","hlc_GRD_Red:3"
    #define WEST_GLRIFLE_MAG_HE "hlc_VOG25_AK:8"
    #define WEST_GLRIFLE_MAG_FLARE "UGL_FlareRed_F:2","UGL_FlareWhite_F:2"

	//Carbine
    #define WEST_CARBINE "hlc_rifle_ak12"
    #define WEST_CARBINE_MAG "hlc_30Rnd_545x39_t_ak:8"
    ...
    // AR
    #define WEST_AR "hlc_rifle_RPK12"
   ...
   // Spotter Rifle
    #define WEST_SPOTTER "hlc_rifle_ak12"
    #define WEST_SPOTTER_MAG "hlc_30Rnd_545x39_t_ak:5"

	// SMG
    #define WEST_SMG "hlc_rifle_aku12"
    #define WEST_SMG_MAG "hlc_30Rnd_545x39_t_ak:5"
...
// Support Infantry
    ...
    class B_support_Mort_F: B_Soldier_F {// Mortar Gunner
        weapons[] = {WEST_CARBINE};
        magazines[] = {"hlc_30Rnd_545x39_t_ak:5"};
    ...
    class B_support_AMort_F: B_Soldier_F {// Assistant Mortar
        backpack[] = {"rhs_assault_umbts"}; /// randomized
        linkedItems[] += {"rhs_pdu4"};
		magazines[] = {"hlc_30Rnd_545x39_t_ak:4"};
