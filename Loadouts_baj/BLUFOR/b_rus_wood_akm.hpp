//Author: TheRob
//Description: Russian Army Alpenflage AKM
// ====================================================================================
...
class blu_f {
	...
	//Rifle
    #define WEST_RIFLE "rhs_weap_akm"
    #define WEST_RIFLE_MAG "rhs_30Rnd_762x39mm:8"

	//GL Rifle
    #define WEST_GLRIFLE "rhs_weap_akm_gp25"
    #define WEST_GLRIFLE_MAG "rhs_30Rnd_762x39mm:8"
	...
	//Carbine
    #define WEST_CARBINE "rhs_weap_akm"
    #define WEST_CARBINE_MAG "rhs_30Rnd_762x39mm:8"
	...
	// AT
    #define WEST_AT "rhs_weap_rpg7"
    #define WEST_AT_MAG "rhs_rpg7_PG7VR_mag:1","rhs_rpg7_PG7VL_mag:2"
   ...
   // Spotter Rifle
    #define WEST_SPOTTER "rhs_weap_akm"
    #define WEST_SPOTTER_MAG "rhs_30Rnd_762x39mm:5"

	// SMG
    #define WEST_SMG "rhs_weap_akms"
    #define WEST_SMG_MAG "rhs_30Rnd_762x39mm:5"
