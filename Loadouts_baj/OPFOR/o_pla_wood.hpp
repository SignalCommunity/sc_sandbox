...
// Leadership INF and Groupies
    ...
    class O_Soldier_F {// rifleman
        uniform[] = {"PLA_CombatUniform_SW"};  /// randomized
        vest[] = {"PLA_T15Vest_RF","PLA_B04_RF"}; /// randomized
        headgear[] = {"VME_PLA_Helmet","VME_PLA_Helmet_G"}; /// randomized
        backpack[] = {"PLA_AssaultPack_Base"}; /// randomized
        ...
        linkedItems[] = {"ItemMap","ItemCompass","ItemWatch","NVGoggles_INDEP"};
        attachments[] = {};
    };

    class O_officer_F: O_Soldier_F {// CO and DC
        weapons[] = {EAST_GLRIFLE};
        vest[] = {"PLA_T15Vest_RD"}; /// randomized
        headgear[] = {"VME_PLA_Helmet_R_O","VME_PLA_Helmet_R"}; /// randomized
        ...
        linkedItems[] = {"ItemMap","ItemCompass","ItemWatch","NVGoggles_INDEP","ItemGPS","Laserdesignator_03"};
        items[] = {"ACE_MapTools","ACRE_PRC148","ACE_Flashlight_MX991"};
    };

    class O_Soldier_SL_F: O_Officer_F {// SL
        linkedItems[] = {"ItemMap","ItemCompass","ItemWatch","NVGoggles_INDEP","ItemGPS","Binocular"};
...
// Support Infantry
    ...
    class O_spotter_F {// Spotter
        ...
        linkedItems[] = {"ItemMap","ItemCompass","ItemWatch","ItemGPS","Laserdesignator_03"};
        attachments[] = {};
    };
...
// Vehicle Infantry
    ...
    class O_Helipilot_F {// Pilot
        ...
        items[] = {"MEDICAL_STANDARD","ACRE_PRC148"};
        linkedItems[] = {"ItemMap","ItemCompass","ItemWatch","itemGPS","NVGoggles_INDEP"};
    };
    ...
    class O_Pilot_F: O_Helipilot_F { // Pilot
        uniform[] = {"U_B_HeliPilotCoveralls"};  /// randomized
        headgear[] = {"U_B_HeliPilotCoveralls"}; /// randomized
    };

    class O_crew_F {// Crew
        uniform[] = {"PLA_CombatUniform_SW"};  // randomized
        vest[] = {}; // randomized
        headgear[] = {"VME_PLA_Helmet_R"}; /// randomized
        backpack[] = {"PLA_AssaultPack_Base"};
