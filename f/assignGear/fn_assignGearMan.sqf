...
private _isPilot = _loadout in ["Helipilot_F","helicrew_F","Pilot_F"];
...
_loadoutArray = [_path,_weaponFamily,_armament,_isPilot,side _unit] call F_fnc_getLoadoutFromConfig;
